# proxmox-download-files

OpenTofu module for `proxmox download files` resources.

Migrated from `kholisrag/labirin` `modules/opentofu/proxmox/download-files/0.1.0`.
...
Floating tags `proxmox-download-files/v0` and `proxmox-download-files/v0.1` track the latest matching release.
